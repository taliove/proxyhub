...
<p align="center">
  ...
  <a href="https://github.com/taliove/proxyhub/releases"><img src="https://img.shields.io/github/v/release/taliove/proxyhub" alt="GitHub Release" /></a>
...
```bash
VERSION=$(curl -fsSL -o /dev/null -w '%{url_effective}' https://github.com/taliove/proxyhub/releases/latest | sed 's|.*/v||')
