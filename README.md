...
<p align="center">
  把多个机场订阅聚合成一个统一订阅地址 —— 自动筛选最优节点，一个链接全设备通用。
</p>
...
<p align="center">
  <img src="docs/images/dashboard.png" alt="ProxyHub 仪表盘" width="880" /><br/>
  <sub><b>仪表盘</b> — 节点池、订阅地址、拉取统计，一页看全</sub>
</p>
...
- 📡 **多格式输出** — 自动识别客户端，Clash 系返回 YAML，其余默认通用(base64)订阅
- 🔬 **深度体检** — 综合评分、多地域测速、稳定性指标、流媒体/AI 解锁检测，报告可分享
...
<p align="center">
  <img src="docs/images/node-exam-report.png" alt="节点深度体检报告" height="560" />
  <img src="docs/images/node-exam-share.png" alt="体检分享卡片" height="560" />
</p>
<p align="center">
  <sub><b>深度体检报告</b>(左):评分 · 测速 · 稳定性 · 解锁，一次看清 &nbsp;·&nbsp; <b>体检分享卡片</b>(右):一键生成，随手转发</sub>
</p>
