<template>
  <div>
    <PageHeader
      description="本机实测：浏览器直连经你客户端代理的节点测真实链路带宽与延迟，再与直连基线对比节点开销"
    />
    ...
    <el-card class="control-card">
      ...
      <div class="control-hint">
        标注当前链路对应的节点（或留空表示直连），点「开始实测」：浏览器会直接经你客户端代理的节点下载公共测速文件（8
        并行连接，流量可见于 DevTools Network），测出真实链路带宽、延迟与抖动。<br />
        历史列表右侧的 Δ
